...
(function () {
  ...
  function buildHUD() {
    ...
    itemEl.style.cssText = `position:absolute;top:140px;left:20px;font-family:var(--font-cond,'Barlow Condensed',sans-serif);font-size:0.85rem;font-weight:600;letter-spacing:0.1em;color:#e8e0d0;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.15);padding:5px 12px;border-radius:4px;pointer-events:none;z-index:20;white-space:pre-line;`;
